    ...
    <div class="footer-main container">
        ...
        <div class="footer-column footer-contact">
            ...
            <div class="footer-social">
                <a class="footer-social-link footer-social-link-facebook" href="https://www.facebook.com/share/19MHhoyvtE/?mibextid=wwXIfr" target="_blank" rel="noreferrer" aria-label="Facebook">
                ...
                <a class="footer-social-link footer-social-link-tiktok" href="https://www.tiktok.com/@canecorsopuppies60?_r=1&amp;_t=ZS-98aYUPnTKDM" target="_blank" rel="noreferrer" aria-label="TikTok">
                    <svg viewBox="0 0 24 24" aria-hidden="true">
...
<script src="<?= $basePath; ?>/assets/js/site.min.js?v=<?= filemtime(__DIR__ . '/../assets/js/site.min.js') ?? time(); ?>" defer></script>
...
<script type="text/javascript">
    ...
    (function() {
        ...
        s1.async = true;
        s1.src = 'https://embed.tawk.to/6a79a52345989d1d4159ab60/1jvliq5ij';
        s1.charset = 'UTF-8';
